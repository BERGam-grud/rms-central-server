-- 003_sync_engine_soft_delete.sql
-- RMS Sync Engine v3: stable bidirectional sync + soft delete support.
...
ALTER TABLE IF EXISTS sync_state ADD COLUMN IF NOT EXISTS last_push TIMESTAMPTZ NOT NULL DEFAULT '1970-01-01 00:00:00+00';
ALTER TABLE IF EXISTS sync_state ADD COLUMN IF NOT EXISTS last_pull TIMESTAMPTZ NOT NULL DEFAULT '1970-01-01 00:00:00+00';
ALTER TABLE IF EXISTS sync_state ADD COLUMN IF NOT EXISTS last_sync TIMESTAMPTZ;
ALTER TABLE IF EXISTS sync_state ADD COLUMN IF NOT EXISTS status TEXT;
ALTER TABLE IF EXISTS sync_state ADD COLUMN IF NOT EXISTS error TEXT;
